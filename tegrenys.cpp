...
Tegrenys::Tegrenys(QWidget *parent, Qt::WFlags flags)
{
	...
	System->CreateModule(TGVIDEOWIDGET_TYPE_UID, UID("{D887D9A2-C050-4a77-881C-6065DD98B025}"));
	System->CreateModule(TGDXVIEWPORT_TYPE_UID, UID("{B9E2204C-8265-4482-949F-F6B8D98F13C3}"));
	System->CreateModule(TGDXPRIMITIVELAYER_TYPE_UID, UID("{005E9139-659E-469d-8D7F-89AF60A78C39}"));
	System->CreateModule(TGBASE_VIDEO_RECTANGLE_TYPE_UID, UID("{8A179B79-5A2B-4a89-A359-ACD963E8D9EE}"));
	System->CreateModule(TG_IP9100_TYPE_UID, "{0F6BECA6-08CE-41c7-A81D-4DBA0BDC00C5}");
